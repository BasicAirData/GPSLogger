//Script that find best calibration parameter, to be used with DataDisplay script
...
Rair=R*1000/Mwa;
ncampionecalibrazionebaro=1500;
m=200; //Windows for correction
