...
//The barometer is zeroed with the altitude of the point indicated by ncampionecalibrazionebaro var. It is possible to find the best fit running FindBestCalibration and reading ibest var value.
//BAROP Array with measured pressures
//BAROA Array with calibrated barometric altitude
//GPSA GPS Array of measured values
clear
...
for i =(m+1):(rs)
    ...
    //timeofvariation = sample interval * m
    tdrift=tsample*m
    ...
    SUPLIM(i,1)=CORRA(i,1)+AbsLim;   //Vector of confidence interval of corrected altitude
