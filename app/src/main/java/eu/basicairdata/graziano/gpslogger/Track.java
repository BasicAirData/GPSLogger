...
public class Track {
    ...
    public static final int TRACK_TYPE_SKATEBOARDING    = 25;
    public static final int TRACK_TYPE_ROLLERSKATING    = 26;
    public static final int TRACK_TYPE_WHEELCHAIR       = 27;
    public static final int TRACK_TYPE_ELECTRICSCOOTER  = 28;
    public static final int TRACK_TYPE_MOPED            = 29;
    ...
    public static final int TRACK_TYPE_PHOTOGRAPHY      = 38;
    public static final int TRACK_TYPE_RESEARCH         = 39;
    public static final int TRACK_TYPE_SOCCER           = 40;
    public static final int TRACK_TYPE_GOLF             = 41;
    public static final int TRACK_TYPE_PETS             = 42;
    public static final int TRACK_TYPE_MAP              = 43;
    ...
    public static final int[] ACTIVITY_DRAWABLE_RESOURCE = {    // The indexes must match the Track Types previously defined:
            ...
            R.drawable.ic_tracktype_skateboarding_24,           // SKATEBOARDING    = 25
            R.drawable.ic_tracktype_roller_skating_24,          // ROLLERSKATING    = 26
            R.drawable.ic_tracktype_wheelchair_24,              // WHEELCHAIR       = 27
            R.drawable.ic_tracktype_electric_scooter_24,        // ELECTRICSCOOTER  = 28
            R.drawable.ic_tracktype_moped_24,                   // MOPED            = 29
            ...
            R.drawable.ic_tracktype_camera_24,                  // PHOTOGRAPHY      = 38
            R.drawable.ic_tracktype_search_24,                  // RESEARCH         = 39
            R.drawable.ic_tracktype_sports_soccer_24,           // SOCCER           = 40
            R.drawable.ic_tracktype_golf_24,                    // GOLF             = 41
            R.drawable.ic_tracktype_pets_24,                    // PETS             = 42
            R.drawable.ic_tracktype_map_24                      // MAP              = 43
    };
    ...
    public static final String[] ACTIVITY_DESCRIPTION = {       // The indexes must match the Track Types previously defined:
            ...
            "skateboarding",                                    // SKATEBOARDING    = 25
            "roller_skating",                                   // ROLLERSKATING    = 26
            "wheelchair",                                       // WHEELCHAIR       = 27
            "electric_scooter",                                 // ELECTRICSCOOTER  = 28
            "moped",                                            // MOPED            = 29
