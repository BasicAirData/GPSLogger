...
public class Track {
    ...
    public static final int TRACK_TYPE_ROCKET           = 23;
    public static final int TRACK_TYPE_PARAGLIDING      = 24;
    public static final int TRACK_TYPE_AIRBALLOON       = 25;
    public static final int TRACK_TYPE_SKATEBOARDING    = 26;
    public static final int TRACK_TYPE_ROLLERSKATING    = 27;
    public static final int TRACK_TYPE_WHEELCHAIR       = 28;
    public static final int TRACK_TYPE_ELECTRICSCOOTER  = 29;
    public static final int TRACK_TYPE_MOPED            = 30;
    public static final int TRACK_TYPE_MOTORCYCLE       = 31;
    public static final int TRACK_TYPE_TRUCK            = 32;
    public static final int TRACK_TYPE_BUS              = 33;
    public static final int TRACK_TYPE_TRAIN            = 34;
    public static final int TRACK_TYPE_AGRICULTURE      = 35;
    public static final int TRACK_TYPE_CITY             = 36;
    public static final int TRACK_TYPE_FOREST           = 37;
    public static final int TRACK_TYPE_WORK             = 38;
    public static final int TRACK_TYPE_PHOTOGRAPHY      = 39;
    public static final int TRACK_TYPE_RESEARCH         = 40;
    public static final int TRACK_TYPE_SOCCER           = 41;
    public static final int TRACK_TYPE_GOLF             = 42;
    public static final int TRACK_TYPE_PETS             = 43;
    public static final int TRACK_TYPE_MAP              = 44;
    ...
    public static final int[] ACTIVITY_DRAWABLE_RESOURCE = {    // The indexes must match the Track Types previously defined:
            ...
            R.drawable.ic_tracktype_rocket_24,                  // ROCKET           = 23
            R.drawable.ic_tracktype_paragliding_24,             // PARAGLIDING      = 24
            R.drawable.ic_tracktype_airballoon_24,              // AIRBALLOON       = 25
            R.drawable.ic_tracktype_skateboarding_24,           // SKATEBOARDING    = 26
            R.drawable.ic_tracktype_roller_skating_24,          // ROLLERSKATING    = 27
            R.drawable.ic_tracktype_wheelchair_24,              // WHEELCHAIR       = 28
            R.drawable.ic_tracktype_electric_scooter_24,        // ELECTRICSCOOTER  = 29
            R.drawable.ic_tracktype_moped_24,                   // MOPED            = 30
            R.drawable.ic_tracktype_sports_motorsports_24,      // MOTORCYCLE       = 31
            R.drawable.ic_tracktype_truck_24,                   // TRUCK            = 32
            ...
            R.drawable.ic_tracktype_search_24,                  // RESEARCH         = 40
            R.drawable.ic_tracktype_sports_soccer_24,           // SOCCER           = 41
            R.drawable.ic_tracktype_golf_24,                    // GOLF             = 42
            R.drawable.ic_tracktype_pets_24,                    // PETS             = 43
            R.drawable.ic_tracktype_map_24                      // MAP              = 44
    };
    ...
    public static final String[] ACTIVITY_DESCRIPTION = {       // The indexes must match the Track Types previously defined:
            ...
            "rocket",                                           // ROCKET           = 23
            "paragliding",                                      // PARAGLIDING      = 24
            "air_balloon",                                      // AIRBALLOON       = 25
            "skateboarding",                                    // SKATEBOARDING    = 26
            "roller_skating",                                   // ROLLERSKATING    = 27
            "wheelchair",                                       // WHEELCHAIR       = 28
            "electric_scooter",                                 // ELECTRICSCOOTER  = 29
            "moped",                                            // MOPED            = 30
            "motorcycle",                                       // MOTORCYCLE       = 31
            "truck",                                            // TRUCK            = 32
            "bus",                                              // BUS              = 33
            "train",                                            // TRAIN            = 34
            "agriculture",                                      // AGRICULTURE      = 35
            "city",                                             // CITY             = 36
            "forest",                                           // FOREST           = 37
            "work",                                             // WORK             = 38
